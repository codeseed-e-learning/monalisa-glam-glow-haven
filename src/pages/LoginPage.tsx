...
const LoginPage = () => {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    toast({
      ...
      description: "Welcome back to Monalisa Beauty Parlor.",
      duration: 3000,
    });
        ...
        <div className="max-w-md mx-auto">
          <div className="bg-white rounded-2xl shadow-lg p-8">
            <div className="text-center mb-8">
              ...
              <p className="text-gray-600 mt-2">Log in to your Monalisa account</p>
            </div>
            ...
            <form onSubmit={handleSubmit}>
              <div className="space-y-4">
                ...
                <div className="flex items-center justify-between">
                  ...
                  <a href="#" className="text-sm text-rose-600 hover:text-rose-800">
                    Forgot password?
                  </a>
                </div>
            ...
            <div className="mt-6 text-center">
              <p className="text-gray-600">
                ...
                <Link to="/register" className="text-rose-600 hover:text-rose-800 font-medium">
                  Sign up
                </Link>
              </p>
            </div>

            ...
            <div>
              ...
              <div className="space-y-8">
                <div className="flex items-start">
                  <div className="mr-4 bg-rose-100 p-3 rounded-full">
                    <MapPin className="h-6 w-6 text-rose-600" />
                  </div>
                  <div>
                    <h3 className="font-semibold text-gray-900 mb-1">Our Location</h3>
                    <p className="text-gray-700">123 Beauty Street</p>
                ...
                <div className="flex items-start">
                  ...
                  <div>
                    ...
                    <p className="text-gray-700">info@monalisa.com</p>
                    <p className="text-gray-700">bookings@monalisa.com</p>
                  </div>
                </div>
                ...
                <div className="flex items-start">
                  ...
                  <div>
                    ...
                    <p className="text-gray-700">General: (123) 456-7890</p>
                    <p className="text-gray-700">Bookings: (123) 456-7891</p>
                  </div>
                </div>
              ...
              <div className="mt-10">
                ...
                <div className="flex space-x-4">
                  <a href="#" className="bg-rose-100 p-2 rounded-full hover:bg-rose-200 transition-colors">
                    <svg className="h-5 w-5 text-rose-600" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
      ...
      <section className="py-12 bg-gray-50">
        <div className="container mx-auto px-4">
          <div className="text-center mb-8">
            ...
            <p className="text-gray-700">Visit our beauty parlor today</p>
          </div>
